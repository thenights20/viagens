(() => {
  ...
  let data = {version:'0.2.1',generated_at:null,results:[],sources:{}};
  ...
  panel.innerHTML = `
    <div class="miles-titlebar">
      <div><strong>⭐ Buscar passagens por milhas · v0.2.1</strong><small>Mesmo modelo de período da busca paga: mês inteiro ou intervalo de datas. A tabela exibe somente milhas.</small></div>
  ...
  async function loadData(){
    ...
    catch{data={version:'0.2.1',generated_at:null,results:[],sources:{}};}
