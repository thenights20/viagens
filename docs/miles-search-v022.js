(() => {
  ...
  panel.innerHTML = `
    <div class="miles-titlebar">
      <div><strong>⭐ Buscar passagens por milhas · v0.2.2</strong><small>Mesmo modelo de período da busca paga: mês inteiro ou intervalo de datas. A tabela exibe somente milhas.</small></div>
